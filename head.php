...
<!-- <div class="tableHead">
    <a id="nav-services" href="/Pages/AdminPanel/Services.php">Услуги</a>
...
<div class="tableHead">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <a id="nav-ski_pass" href="/Pages/AdminPanel/Ski_Pass.php">Открыть таблицу</a>
            <a href="#">Добавить данные</a>
        </div>
    </div>
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <a id="nav-staff" href="/Pages/AdminPanel/Staff.php">Открыть таблицу</a>
            <a href="#">Добавить данные</a>
        </div>
    </div>
    <div class="dropdown">
